...
const Slide1 = ({ aboutData }: { aboutData: AboutPageData }) => (
    <div className="w-full flex flex-col justify-center py-16 md:py-0">
        <div className="container mx-auto flex flex-col justify-center">
            ...
            <div className="text-white prose-lg max-w-none text-justify flex flex-col justify-center order-2 md:order-1">
                <div>
            ...
            <div className="min-h-[300px] md:min-h-0 h-64 md:h-full w-full relative rounded-lg overflow-hidden shadow-2xl order-1 md:order-2">
...
const Slide2 = ({ aboutData }: { aboutData: AboutPageData }) => {
    const values = [
    ...
    return (
        <div className="w-full flex flex-col justify-center py-16 md:py-0">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center text-white">
