...
import { LogOut, UserCircle, ShoppingCart, CreditCard, ShoppingBag, Star, Home, User, Mail, Phone, Calendar, BarChart2, Save, PlusCircle, Link2, Gem, FileText, Wallet } from "lucide-react";
                  ...
                  <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                          <div className="space-y-1">
                           ...
                           <div className="space-y-1">
                                <p className="text-xs font-medium text-gray-300 flex items-center gap-1"><Wallet className="h-3 w-3" /> Баланс</p>
                                <p className="text-sm font-semibold">{profile?.balance?.toLocaleString('ru-RU') || '0.00'} BYN</p>
                          </div>
                          <div className="space-y-1">
